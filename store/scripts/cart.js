...
function printCart() {
  ...
  if (cartproducts === null || cartproducts.length === 0) {
    ...
    <article class="product-cart">
        <div class="title-product">No hay productos en el carrito UnU</div>
    </article>
    `;
  } else {
    ...
    cartproducts.forEach((product) => {
      ...
      //Agregar la clase product al div, classList muestra la lista de clases del elemento y el "add" agrega una clase
      productDiv.classList.add("product-cart");
      //Agregar el contenido al div
      productDiv.innerHTML = `
    <img class="product-img" src="${product.photos}">
